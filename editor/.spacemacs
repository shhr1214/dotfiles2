...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-mode-line-theme '(custom :separator wave :separator-scale 1.2)
